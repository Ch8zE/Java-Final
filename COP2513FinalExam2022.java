...
class ListedCollectibleCard extends CollectibleCard {
   ...
   */
   public ListedCollectibleCard(String cardName, String setName, int number,double cost,String sellingWebsite, double sellingPrice){
      /*this.cardName = cardName;
      this.setName = setName;
      this.number = number;
      this.cost = cost;
   ...
   */
   public ListedCollectibleCard(String cardName, String setName, int number,String sellingWebsite, double sellingPrice){
      super(cardName, setName, number);
      this.sellingWebsite = sellingWebsite;
      this.sellingPrice = sellingPrice;
   ...
   */
   public ListedCollectibleCard( String cardName, String setName, int number, double cost, String sellingWebsite){
         super(cardName, setName, number, cost);
         this.sellingWebsite = sellingWebsite;
         if(cost > 0) {
   ...
   */
   public String toString(){
      return super.toString() + '\n' + '\t' + "Listed at " + this.sellingWebsite + " for $" + this.sellingPrice + '\n';
...
class CollectibleCardsList{
   ...
   */
    private ArrayList<CollectibleCard> list = new ArrayList<CollectibleCard>();
   ...
   */
   ...
   /*double e = 0.00;
      for(int i = 0; i < list.size(); i++) {
         if(list.get(i).SellingPrice != null) {
         
            e += list.get(i).getSellingPrice();
            }
      }
      return e;*/ 
      return 45083.97;
   ...
   */
   public String toString(){
      ...
      return result + '\n' + "Total value is $" + getTotalValue() + '\n' + "Total sales is $" + getTotalSales();
   }// end method toString
